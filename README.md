...
| **VERTEX_REGION_CLAUDE_*** | Region overrides for each Claude model on Vertex AI (`VERTEX_REGION_CLAUDE_3_5_HAIKU`, `VERTEX_REGION_CLAUDE_3_5_SONNET`, `VERTEX_REGION_CLAUDE_4_5_OPUS`, … through `VERTEX_REGION_CLAUDE_4_7_OPUS`, `VERTEX_REGION_CLAUDE_HAIKU_4_5`, `VERTEX_REGION_DEFAULT`, `VERTEX_REGION_SMALL_FAST_MODEL`) |
...
| **Google Cloud** | `GCLOUD_PROJECT`, `GOOGLE_CLOUD_PROJECT`, `GOOGLE_APPLICATION_CREDENTIALS`, `VERTEX_AI_PROJECT_ID`, `CLOUD_RUN_JOB_ATTEMPT`, `CLOUD_ML_REGION` |
...
| **Network/TLS** | `HTTP_PROXY`, `HTTPS_PROXY`, `NO_PROXY`, `NODE_EXTRA_CA_CERTS`, `USE_BUILTIN_CA_BUNDLE` |
